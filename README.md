...
*   **`send_email_notification`**: Sends an email notification given a list email of addresses and email body.</td>
	...
	<tr>
		<td><a href="https://raw.githubusercontent.com/equinix/agent-factory/refs/heads/main/agent_factory_schema/equinix/fabric/v1/run_once/pending-state-tracker.md">Project Lifecycle Activities Insight Agent<br>[pending-state-tracker.md]</a></td>
