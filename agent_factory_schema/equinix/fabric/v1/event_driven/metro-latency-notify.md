...
## Overview
This skill sets up and activate an Equinix agent that automatically email a list of connections that are over the metros where latency spike.This agent can only run once.
