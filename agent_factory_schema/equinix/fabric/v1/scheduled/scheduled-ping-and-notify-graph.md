---
name: scheduled-ping-fcr-and-notify-graph
...
This agent is triggered immediately after creation, then triggered at 4pm every day.
...
6. Next, send an email notification to the recipient email address, using the outcome of the search router command as the email body so the recipient is clearly informed of the connectivity status and any relevant diagnostic information.
