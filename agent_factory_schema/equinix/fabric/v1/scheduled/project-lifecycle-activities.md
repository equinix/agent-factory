...
## Overview
This definition sets up and activates an Equinix agent that continuously analyzes Fabric Cloud Events to generate a scheduled cloud event intelligence report across assets including organizations, projects, Fabric Cloud Routers, ports, and connections.
The agent searches for all cloud events within a given project over the last day, distills the most important operational insights, and delivers a concise audit summary via email notification.
This agent is triggered once every day.
...
## Capabilities
- Search cloud events across all asset types within a project for the last 24 hours
