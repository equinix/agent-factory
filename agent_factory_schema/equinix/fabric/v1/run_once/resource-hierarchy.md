...
### Step 2
For each Fabric Cloud Router, search for FCR connections of it which are not in deprovisioned status. Summarize the distribution of connection type, bandwidth.
### Step 3
