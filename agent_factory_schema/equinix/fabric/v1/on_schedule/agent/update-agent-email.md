...
4. For each collected agent, call `update_agent_email(agent_id, old_email, new_email)`:
...
5. After all agents are processed, report the full summary: total scanned, total updated, total failed.
